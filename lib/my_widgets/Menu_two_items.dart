...
import 'package:flutter_whatsapp/my_widgets/painter.dart';
...
class Menu2Items extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 300.0,
      height: 50.0,
      decoration: BoxDecoration(color: Color.fromRGBO(143, 148, 251, 1), borderRadius: BorderRadius.all(Radius.circular(25.0))),
      child: CustomPaint(
