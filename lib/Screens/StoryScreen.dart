              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: FutureBuilder(
                      future: getNameOfNumber(story.numCreator),
                      builder: (context, snapshot) {
                        if(snapshot.hasData){
                          return UserInfo(user: ContactModel(name: snapshot.data, urlPhoto: story.urlPhoto));
                        }
                        return UserInfo(user: ContactModel(name: story.numCreator, urlPhoto: story.urlPhoto));
                      }
                    ),
                  ),
                ],
  ...
  void _loadStory({StoryModel story, bool animateToPage = true}) {
    ...
    switch (story.mediaType) {
      ...
      case "video":
        ...
        _videoController?.dispose();
        _videoController = VideoPlayerController.network(story.urlMedia)
          ..initialize().then((_) {
            setState(() {});
