...
class ReplyCardGroup extends StatefulWidget {
  const ReplyCardGroup(
      {Key key, this.message, this.time, this.url, this.sent, this.mediaType, this.name})
      : super(key: key);
  ...
  _ReplyCardGroupState createState() => _ReplyCardGroupState();

}

class _ReplyCardGroupState extends State<ReplyCardGroup> with TickerProviderStateMixin{
              ...
              children: [
                Column(
                  children: [
                    ...
                    SizedBox(height: 10,),
                    Padding(
                      padding: const EdgeInsets.only(left: 10, right: 60, top: 2, bottom: 3),
